...
model = LGBMClassifier(n_estimators=1436, depth=8, fold_permutation_block=113, learning_rate=0.41550106192795455,
                       od_pval=0.3774575184029537, l2_leaf_reg=0.04747778152681992, random_state=1372
)
...
# 걸린 시간 :  1.3268828392028809 초
# acc :  0.9425986246833152
# cv pred :  [0 0 0 ... 0 1 0]
# Classification Report : 
#               precision    recall  f1-score   support

#            0       0.96      0.96      0.96     22028
#            1       0.85      0.84      0.84      5602

#     accuracy                           0.94     27630
#    macro avg       0.90      0.90      0.90     27630
# weighted avg       0.94      0.94      0.94     27630

# cv pred acc :  0.93695258776692
# avg acc:  0.93695258776692
# acg std:  0.0
