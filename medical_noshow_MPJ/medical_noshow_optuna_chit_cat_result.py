...
model = CatBoostClassifier(n_estimators=2701, depth=9, fold_permutation_block=220, learning_rate=0.3559458238870571,
                            od_pval=0.26848515404937034, l2_leaf_reg=1.898736655886022, random_state=1296
)
...
#            0       0.96      0.96      0.96     22087
#            1       0.85      0.85      0.85      5543

#     accuracy                           0.94     27630
#    macro avg       0.91      0.91      0.91     27630
# weighted avg       0.94      0.94      0.94     27630

# cv pred acc :  0.9401737242128122
# avg acc:  0.9401737242128122
# acg std:  0.0