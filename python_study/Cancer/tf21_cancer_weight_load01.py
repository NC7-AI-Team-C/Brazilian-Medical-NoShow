...
model.load_weights('./_save/tf22_weight_cancer.h5')
...
#           callbacks=[earlystopping])    # verbose로 결과값 추출 로딩 제어
...
## epochs 1000일때 & patience 100일 때
# Epoch 307: early stopping
# loss :  [0.28563612699508667, 0.06431667506694794]
# Accuracy 스코어 :  0.9298245614035088
# 걸린 시간 :  8.12316608428955


## weight
# loss :  [0.14933468401432037, 0.045128460973501205]
# Accuracy 스코어 :  0.935672514619883
