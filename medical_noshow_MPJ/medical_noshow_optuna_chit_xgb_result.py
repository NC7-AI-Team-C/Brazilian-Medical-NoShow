...
model = XGBClassifier(n_estimators=2060, depth=12, fold_permutation_block=11, learning_rate=0.49004237355011937,
                      od_pval=0.32505770689105074, l2_leaf_reg=0.023601444789493886, random_state=289
)
...
# 걸린 시간 :  32.642356872558594 초
# acc :  0.941295693087224
# cv pred :  [0 1 0 ... 0 0 1]
# Classification Report :
#               precision    recall  f1-score   support

#            0       0.96      0.96      0.96     22017
#            1       0.85      0.84      0.85      5613

#     accuracy                           0.94     27630
#    macro avg       0.91      0.90      0.91     27630
# weighted avg       0.94      0.94      0.94     27630

# cv pred acc :  0.9387984075280492
# avg acc:  0.9387984075280492
# acg std:  0.0
