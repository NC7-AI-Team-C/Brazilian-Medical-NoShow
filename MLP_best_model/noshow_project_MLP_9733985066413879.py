...
mcp = ModelCheckpoint(
    ...
    verbose=1,
    save_best_only=True,
    filepath='./mcp/noshow_ver5_layer2_bat32_16_64_64_1.hdf5'
    ######################################
...
# 2211/2211 [==============================] - 10s 5ms/step - loss: 0.0528 - accuracy: 0.9721 - val_loss: 0.0541 - val_accuracy: 0.9729
# Epoch 00240: early stopping
# 691/691 [==============================] - 2s 3ms/step - loss: 0.0510 - accuracy: 0.9734
# Model: "sequential"
...
# _________________________________________________________________
# 소요시간 :  2418.9604835510254
# batch_size :  32
# loss :  0.051016245037317276
