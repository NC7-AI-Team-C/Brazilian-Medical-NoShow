...
model = LGBMClassifier(
    n_estimators = 3636, learning_rate = 0.3880556792419577, random_state = 232
)
...
# noshow_전처리ver2_selection_lgbm.py

# acc :  0.9692363373145132
# 소요시간 :  30.41937232017517
# (66311, 6) (22104, 6)
# Thresh=8.000, n=6, acc:97.22%
